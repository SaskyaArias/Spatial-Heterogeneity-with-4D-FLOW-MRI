...
% Fractional Anisotropy (FA) peak values
[struct.FAE, struct.FAE_sd] = peak_strains(structure.FAE, structure.FAE_sd);
[struct.FAL, struct.FAL_sd] = peak_strains(structure.FAL, structure.FAL_sd);
[struct.FASR, struct.FASR_sd] = peak_strains(structure.FASR, structure.FASR_sd,peak_frame);
